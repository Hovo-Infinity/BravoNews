...
let dataFetchEnd: Notification.Name = Notification.Name(rawValue: "dataFetchEnd")
...
class DataService: NSObject {
    ...
    func startFetchingData() {
        ...
        requestController.comletion = {[unowned self](UrlResponse, data) in
            ...
            NotificationCenter.default.post(name: dataFetchEnd, object: nil, userInfo: userInfo)
        }
    ...
    func clearDatabase() {
        ...
        do {
            try self.persistentContainer.persistentStoreCoordinator.execute(deleteRequest, with: DataService.viewContext())
            DataService.saveContext()
        } catch {
